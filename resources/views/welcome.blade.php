            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <div class="carousel slide carousel-fade" data-ride="carousel" data-interval="2500" id="carousel-1">
                    <div class="carousel-inner">
                        <div class="carousel-item"><img class="img-fluid w-100 d-block" src="{{ asset('panelAssets/img/carousel4.jpg')}}" alt="Slide Image"></div>
                        <div class="carousel-item active"><img class="w-100 d-block" src="{{ asset('panelAssets/img/carousel2.jpg')}}" alt="Slide Image"></div>
                        <div class="carousel-item"><img class="w-100 d-block" src="{{ asset('panelAssets/img/carousel1.jpg')}}" alt="Slide Image"></div>
                    </div>
        ...
        <div class="container pt-5 pb-5">
            ...
            <div class="pb-4">
                <ul class="nav nav-pills d-flex d-xl-flex justify-content-center justify-content-xl-center pb-2" role="tablist" style="margin: 15px;">
                    <li class="nav-item text-monospace" role="presentation"><a class="nav-link active" role="tab" data-toggle="pill" href="#tab-1" style="color: #b17d89;margin: 0px 5px;">FACE</a></li>
...
{{--                    <li class="nav-item text-monospace" role="presentation"><a class="nav-link" role="tab" data-toggle="pill" href="#tab-8" style="margin: 0px 5px;color: #b17d89;">HAIR & MAKE-UP</a></li>--}}
    ...
    <div class="container pt-5" id="contact">
        ...
        <div class="text-center">
            <picture><img class="img-fluid" src="{{ asset('panelAssets/img/logo_logo_logo.png')}}" width="400"></picture>
        </div>
        <div class="p-5">
