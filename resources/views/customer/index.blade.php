...
<head>
    ...
    <title>bnbms</title>
    <link rel="stylesheet" href="{{ asset('public/panelAssets/bootstrap/css/bootstrap.min') }}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lora">
    <link rel="stylesheet" href="{{ asset('public/panelAssets/css/Article-Sidebar') }}">
    <link rel="stylesheet" href="{{ asset('public/panelAssets/css/Footer-Basic') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos">
    <link rel="stylesheet" href="{{ asset('public/panelAssets/css/sidebar') }}">
</head>
...
<ul class="nav flex-column shadow-lg d-flex sidebar mobile-hid" style="background: #f9e8f6;">
    ...
    <li class="nav-item dropdown show"><a class="dropdown-toggle nav-link text-left text-black-50 py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="true" href="#"><i class="fas fa-sliders-h mx-3"></i><span class="text-nowrap mx-2">Reports</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
        <div class="dropdown-menu show border-0 animated fadeIn"><a class="dropdown-item text-white" href="#"><span>Dropdown</span></a><a class="dropdown-item text-white" href="#"><span>Dropdown</span></a><a class="dropdown-item text-white" href="#"><span>Dropdown</span></a></div>
    </li>
    ...
    <li class="nav-item"><a class="nav-link text-left text-black-50 py-1 px-0" href="#"><i class="fas fa-sign-out-alt mx-3"></i><i class="fa fa-caret-right d-none position-absolute"></i><span class="text-nowrap mx-2">Log out</span></a></li>
</ul>
