<nav class="navbar navbar-light align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(255,255,255);">
    <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding: 0px 0px;width: 100%;background: #fe7fe7;">
        ...
        <ul class="navbar-nav text-change" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link" href="tables.html"><i class="fas fa-table" style="color: rgb(133,135,150);"></i><span style="color: rgb(133,135,150);">Reports</span></a></li>
            <li class="nav-item"><a class="nav-link" href="tables.html"><i class="fas fa-table" style="color: rgb(133,135,150);"></i><span style="color: rgb(133,135,150);">Invoices</span></a></li>
