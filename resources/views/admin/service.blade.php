            ...
            <div class="card-body">
                ...
                <div class="table-responsive table mt-2">
                    <table class="table table-hover my-0">
                        <thead>
                            <th wire:click="sortBy('service')" class="sorting">Service</th>
                            <th wire:click="sortBy('category')">Category</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" class="form-control number" name='price' wire:model="price" placeholder='Enter Price' maxlength='11' autocomplete='off'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" class="form-control number" name='price' wire:model="price" placeholder='Enter Price' maxlength='15' autocomplete='off'>
                            @error('price') {{ $message }} @enderror
                        </div>
                    </form>
                </div>
